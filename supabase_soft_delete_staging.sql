-- CrediSync - Soft Delete Implementation (STAGING ONLY)
-- Este script agrega columnas deleted_at para soft-delete y actualiza las constraints
-- Ejecuta este script en SQL Editor de Supabase STAGING
...
-- ========================================
-- 2. Actualizar constraints de foreign keys
--    Cambiar ON DELETE CASCADE a ON DELETE SET NULL o RESTRICT
-- ========================================

-- Drop existing constraints and recreate with SET NULL or RESTRICT
-- Nota: Las constraints que hacen CASCADE a tenants ahora verifican deleted_at

-- ========================================
-- 3. Crear vistas filtradas (sin registros eliminados)
-- ========================================
...
-- ========================================
-- 7. Consulta para ver registros eliminados
-- ========================================

-- Ejemplo: Ver todos los tenants eliminados
-- SELECT * FROM public.tenants WHERE deleted_at IS NOT NULL ORDER BY deleted_at DESC;

-- Ejemplo: Ver todos los usuarios eliminados de un tenant
-- SELECT * FROM public.users WHERE tenant_id = 'TEN-XXX' AND deleted_at IS NOT NULL ORDER BY deleted_at DESC;

-- ========================================
-- 8. Limpieza permanente (opcional, usar con cuidado)
-- ========================================
